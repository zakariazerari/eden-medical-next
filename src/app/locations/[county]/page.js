// app/locations/[county]/page.js - ✅ NEW FILE
"use client";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/locations" className="text-red-600">← Back</Link>
        </div>
      </div>
    );
  }
    ...
    <section className="bg-white">
      <div className="relative bg-gradient-to-r from-red-600 to-blue-700 py-20">
        <div className="max-w-7xl mx-auto px-4 text-white">
          <Link href="/locations" className="inline-flex items-center gap-2 mb-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-6 py-3 bg-white text-red-600 font-bold rounded-xl hover:shadow-2xl"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="flex flex-wrap gap-3 mb-16">
          {county.cities.map(city => (
            <span key={city} className="px-6 py-3 bg-white border-2 rounded-xl font-semibold hover:border-red-600">
              {city}
            </span>
          ))}
        </div>
        ...
        <div className="bg-gradient-to-r from-red-600 to-blue-700 rounded-3xl p-12 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">Need Transportation?</h2>
          <p className="text-xl mb-8">Call now for immediate assistance</p>
          <a
            href={`tel:${county.phone.replace(/[^0-9]/g, '')}`}
            className="inline-block px-8 py-4 bg-white text-red-600 font-bold rounded-xl hover:shadow-2xl text-xl"
          >
            {county.phone}
          </a>
        </div>
