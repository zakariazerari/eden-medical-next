...
export default function AdminLoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-violet-100 via-white to-indigo-100 px-4">
      ...
      >
        <h2 className="text-3xl font-extrabold text-violet-700 mb-8 text-center">
          Admin Login
        </h2>
        ...
        <div className="mb-6 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-violet-500"
          />
        </div>
