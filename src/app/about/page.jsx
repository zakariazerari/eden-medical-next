...
export default function About() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-indigo-50 to-violet-100 py-24">
        <div className="absolute inset-0 z-0">
          <ParticlesMaskBG />
        </div>
        
        <div className="container mx-auto px-6 lg:px-24 relative z-10">
          <h1 className="text-5xl md:text-6xl font-extrabold text-center text-violet-800 mb-6">About Eden Medical Transport</h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                <strong className="text-violet-700 text-xl">Eden Medical Transport</strong> was founded with a simple mission: provide safe, reliable, and compassionate non-emergency medical transportation for those who need it most.
              </p>
              <p>
              ...
              <p className="text-violet-700 font-semibold text-xl">
                Your health matters. So does how you get there.
              </p>
            </div>

            <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-violet-200 transform hover:scale-105 transition-transform duration-500">
              <Image
                src="/image3.jpg"
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-24">
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center transform hover:-translate-y-2 transition-all">
              ...
              <h3 className="text-2xl font-bold text-violet-800 mb-4">Our Mission</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center transform hover:-translate-y-2 transition-all">
              ...
              <h3 className="text-2xl font-bold text-violet-800 mb-4">Our Vision</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl text-center transform hover:-translate-y-2 transition-all">
              ...
              <h3 className="text-2xl font-bold text-violet-800 mb-4">Our Values</h3>
              <p className="text-gray-600">
          ...
          {/* Timeline */}
          <div className="mb-24">
            <h2 className="text-4xl font-extrabold text-center text-violet-800 mb-12">Our Journey</h2>
            <div className="space-y-8 max-w-4xl mx-auto">
              {[
                ...
                <div key={i} className="flex gap-6 items-start">
                  <div className="flex-shrink-0 w-24 h-24 bg-gradient-to-br from-violet-600 to-indigo-600 rounded-full flex items-center justify-center shadow-xl">
                    <span className="text-white font-bold text-lg">{item.year}</span>
                  </div>
                  <div className="flex-1 bg-white p-6 rounded-xl shadow-lg">
                    <h3 className="text-xl font-bold text-violet-800 mb-2">{item.title}</h3>
          ...
          <div className="bg-white p-12 rounded-3xl shadow-2xl">
            <h2 className="text-4xl font-extrabold text-center text-violet-800 mb-8">Certified & Trusted</h2>
