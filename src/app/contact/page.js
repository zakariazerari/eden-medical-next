...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-gradient-to-br from-white via-indigo-50 to-violet-100 py-16 sm:py-24 overflow-hidden">
      <FloatingBubblesBg />
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Form */}
          <form onSubmit={handleSubmit} className="bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-violet-100 transition-transform hover:scale-[1.02]">
            ...
            <button type="submit" className="w-full py-3 bg-violet-600 text-white rounded-xl font-semibold hover:bg-violet-700 transition">
              Send Message
            </button>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {contacts.map((contact, index) => (
                <div key={index} className="flex items-start gap-4 p-5 bg-white border border-violet-100 rounded-2xl shadow-md hover:shadow-lg transform hover:scale-[1.03]">
